...
export function PasswordMatchValidator(ctrl_password: string, ctrl_confirm_password_name: string): ValidatorFn {
    return function (formGroup: AbstractControl): ValidationErrors | null {
        const ctrlPassword = formGroup.get(ctrl_password)
