...
export const _messgePaginator = CreatePagination(_message, _pagination)
export type MessagePaginator = Static<typeof _messgePaginator>
export type message = Static<typeof _message>
export const MessageDto = new Elysia().model({
    pagination: t.Optional(_pagination),
    messages: _messgePaginator
})